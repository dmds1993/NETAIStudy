...
namespace BoardMemberResponse_ConsoleApp1
{
    ...
    {
        /// <summary>
        /// model input class for BoardMemberResponse.
        /// </summary>
        ...
        /// <summary>
        /// model output class for BoardMemberResponse.
        /// </summary>
        ...
        private static string MLNetModelPath = Path.GetFullPath("BoardMemberResponse.mlnet");
        ...
        private static IEnumerable<string> GetLabels(ModelOutput result)
        {
            ...
            var labelColumn = schema.GetColumnOrNull("Text");
            if (labelColumn == null)
            {
                throw new Exception("Text column not found. Make sure the name searched for matches the name in the schema.");
            }

...
namespace BoardMemberResponse_ConsoleApp1
{
    public partial class BoardMemberResponse
    {
        public const string RetrainFilePath =  @"C:\Users\danie\Documents\Study\NETAIStudy\NETAIStudy\Data\email_training_data.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Label",outputColumnName:@"Label")      
                                    .Append(mlContext.Transforms.Concatenate(@"Features", new []{@"Label"}))      
                                    .Append(mlContext.Transforms.Conversion.MapValueToKey(outputColumnName:@"Text",inputColumnName:@"Text",addKeyValueAnnotationsAsText:false))      
                                    .Append(mlContext.MulticlassClassification.Trainers.OneVersusAll(binaryEstimator:mlContext.BinaryClassification.Trainers.FastTree(new FastTreeBinaryTrainer.Options(){NumberOfLeaves=4,MinimumExampleCountPerLeaf=20,NumberOfTrees=4,MaximumBinCountPerFeature=254,FeatureFraction=1,LearningRate=0.09999999999999998,LabelColumnName=@"Text",FeatureColumnName=@"Features",DiskTranspose=false}),labelColumnName: @"Text"))      

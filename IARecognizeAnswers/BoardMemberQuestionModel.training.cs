...
namespace IARecognizeAnswers
{
    public partial class BoardMemberQuestionModel
    {
        public const string RetrainFilePath =  @"C:\Users\danie\Documents\Study\NETAIStudy\NETAIStudy\Data\email_question_datav2.csv";
        ...
        public static IEstimator<ITransformer> BuildPipeline(MLContext mlContext)
        {
            ...
            var pipeline = mlContext.Transforms.Text.FeaturizeText(inputColumnName:@"Text",outputColumnName:@"Text")      
                                    ...
                                    .Append(mlContext.MulticlassClassification.Trainers.SdcaMaximumEntropy(new SdcaMaximumEntropyMulticlassTrainer.Options(){L1Regularization=0.07110276F,L2Regularization=0.03125F,LabelColumnName=@"Label",FeatureColumnName=@"Features"}))      
